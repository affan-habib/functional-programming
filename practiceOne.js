function hasDuplicates(object) {
  ...
  const calculatePrice = (name = "Javascript", price = 100, vat = 0.1) =>
    ...
    // null price is 60
    // default param will not apply when null value found. To avoid this use nullish colesing
    ...
    //convert to boolean two ways
    console.log(Boolean(NaN))
    console.log(!!undefined)
  
    // Imperative VS Declarative Code
        // Imperative
        // Describes Control flows , Usually More verbose
  
    // Declarative 
        // Abstracts Control flows, Abstracts away control flows
  
    const mixedArry = [undefined, 2, null, new String, {key : "value"}, [2,3], [4,6,7]]
  
    const filteredOne = mixedArry.filter(el => typeof el == 'object')
    
    // Expected Return
    // [ null, [String: ''], { key: 'value' }, [ 2, 3 
    // ], [ 4, 6, 7 ] ]
